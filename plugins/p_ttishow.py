    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            k = await message.reply(
                text='<b>CHAT NOT ALLOWED 🐞\n\nMON ADMINISTRATEUR M'A EMPÊCHÉ DE TRAVAILLER ICI ! SI VOUS SOUHAITEZ EN SAVOIR PLUS, CONTACTEZ LE PROPRIÉTAIRE DU SUPPORT...</b>',
        ...
        await message.reply_text(
            text=f"<b>›› MERCI DE M'AJOUTER À VOTRE GROUPE. {message.chat.title} ❣️\n›› N'OUBLIEZ PAS DE ME FAIRE ADMINISTRATEUR.\n›› EN CAS DE DOUTE SUR MON UTILISATION, CLIQUEZ SUR LE BOUTON CI-DESSOUS..⚡⚡.</b>",
            reply_markup=reply_markup)
    else:
